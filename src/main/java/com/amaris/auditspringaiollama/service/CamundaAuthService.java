...
public class CamundaAuthService {
    ...
    public CamundaAuthService(RestTemplate restTemplate,
                              @Value("${camunda.client.operate.auth-server}") String authServer,
                              @Value("${camunda.client.operate.client-id}") String clientId,
                              @Value("${camunda.client.operate.client-secret}") String clientSecret,
                              @Value("${camunda.client.operate.audience}") String audience) {
    ...
    private void refreshToken() {
        try {
            ...
            throw new RuntimeException("Erreur lors de l'authentification Camunda", e);
        }
    }
}